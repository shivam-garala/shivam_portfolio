            ...
            <Card.Body className="d-flex justify-content-center flex-column">
              <div>
                <div className="text-center style">
                  ...
                  <br />
                  <strong>Skills:</strong> Nodejs, Reactjs, MySQL, MongoDB, Git, HTML, CSS, AWS, JIRA
                  <br />
                  <strong>Duration:</strong> July 2022 - Present
                  <br />
                  ...
                  <ul className="text-left">
                    ...
                    <br />
                    <li>
                      <strong>Developed</strong> an Android application that helps with accessibility for those who are blind
                      using JAVA and XML in Android Studios and created a backend database using Firebase for data related to login
